...
export const metadata = buildMetadata({
  title: 'About',
  description:
    'Product Designer and design leader with experience across product, UX/UI, branding, and venture development, based in Johannesburg.',
})
                  ...
                  <StaggerGroup className="flex flex-col gap-4">
                    {section.paragraphs.map((paragraph, index) => (
                      <StaggerItem key={index}>
                        <p className="max-w-[80ch] font-sans text-base font-light leading-relaxed text-ink-secondary">
                          {paragraph}
                        </p>
                      </StaggerItem>
                    ))}
